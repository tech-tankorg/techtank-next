/**
 * Slack helpers: a webhook post for the organizer channel, and bot DMs
 * (1:1 or group). Nothing here throws — by the time these run the DB change
 * is committed, so a Slack hiccup must never turn a success into a 500.
 */
