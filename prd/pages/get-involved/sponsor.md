...
Give corporate partners a distinct, dedicated path to support TechTank
when "host a single event" is not the right fit (e.g. recurring
partnership, swag, travel budget for speakers, etc.).

## 2. Primary audience

- DevRel, marketing, and community-investment leads at tech-adjacent
  companies
- Recruiting and employer-brand teams
- Toronto tech ecosystem partners
...
2. **Why sponsor**
   ...
   - **Recruiting** — sustained exposure to tech talent across levels.
...
- A corporate visitor understands within one scroll what sponsorship
  supports and how to start the conversation.
- The page never claims a sponsorship tier or benefit that organizers
  haven't confirmed.
